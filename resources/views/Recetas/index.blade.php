        ...
        <div class="col-xl-12">
            <form action="{{route('Recetas.index')}}" method="GET">
                <div class="d-flex align-items-center gap-2">
                    <input type="text" class="form-control" name="cocina" value="{{$cocina}}" placeholder="Buscar Receta">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal-delete-{{$receta->id}}">
                                            Eliminar
                                        </button>
                                    </div>
                                </td>
